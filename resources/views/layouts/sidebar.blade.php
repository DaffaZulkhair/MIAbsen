<div class="iq-sidebar  sidebar-default  ">
    <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
        <a href="{{ route('home') }}" class="header-logo">
            <img src="{{ asset('assets/images/mi.png') }}" class="img-fluid rounded-normal light-logo" alt="logo">
            <span>MIAbsen</span>
        </a>
            ...
            <ul id="iq-sidebar-toggle" class="side-menu">
                @role('Admin')
                    ...
                    <li class="px-3 pt-3 pb-2">
                        <span class="text-uppercase small font-weight-bold">Kelola Pengguna</span>
                    </li>
                    <li class="sidebar-layout">
                        <a href="{{ route('user.index') }}" class="svg-icon">
                            ...
                            </i><span class="">Pengguna</span>
                        </a>
                    </li>
                    <li class="px-3 pt-3 pb-2">
                        <span class="text-uppercase small font-weight-bold">Kelola Mahasiswa</span>
                    </li>
                    <li class="sidebar-layout">
                        <a href="{{ route('student.index') }}" class="svg-icon">
                            ...
                            </i><span class="">Kelola Mahasiswa</span>
                        </a>
                    </li>
                ...
                @role('Mahasiswa')
                    ...
                    <li class="px-3 pt-3 pb-2">
                        <span class="text-uppercase small font-weight-bold">Kehadiran Mahasiswa</span>
                    </li>
                    <li class=" sidebar-layout">
                        <a href="#app2" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">
                            <i>
                        ...
                        <ul id="app2" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class=" sidebar-layout">
                                <a href="{{ route('attendance.create') }}" class="svg-icon">
                                    <i class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
