            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-2">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="form-grid" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;row&#x22;&#x3E;
&#x3C;div class=&#x22;col&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-3" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-3">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="Textarea" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-4" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-4">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-telephone" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-5" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-5">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-search" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-7">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-size" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-8" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-8">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="horizontal-form" class="text-white"><code>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-9">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="form-now" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-row&#x22;&#x3E;
&#x3C;div class=&#x22;col&#x22;&#x3E;
 &#x3C;input type=&#x22;text&#x22; class=&#x22;form-control&#x22; placeholder=&#x22;First name&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-10" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-10">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-url" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-11" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-11">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-range" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-12" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-12">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-custom-range" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-13" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-13">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="input-choose-file" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-14">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="form-input2" class="text-white"><code>
&#x3C;form&#x3E;
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
...
&#x3C;/form&#x3E;
                    ...
                    <form>
                        <div class="form-group">
                            <label for="exampleInputDisabled5">Disabled Input</label>
                            <input type="text" class="form-control" id="exampleInputDisabled5" disabled=""
                                value="Mark Tech">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPlaceholder">Placeholder</label>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="header-action">
                        <i data-toggle="collapse" data-target="#form-element-15" aria-expanded="false">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                ...
                <div class="card-body">
                    <div class="collapse" id="form-element-15">
                        <div class="card"><kbd class="bg-dark">
                                <pre id="select-size" class="text-white"><code>
&#x3C;div class=&#x22;form-group&#x22;&#x3E;
&#x3C;label&#x3E;Small&#x3C;/label&#x3E;
